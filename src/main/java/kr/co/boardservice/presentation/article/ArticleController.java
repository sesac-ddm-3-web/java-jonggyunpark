package kr.co.boardservice.presentation.article;

import kr.co.boardservice.application.article.ArticleService;
import kr.co.boardservice.application.comment.CommentService;
...
public class ArticleController {
    ...
    public String detail(@PathVariable Long id,
        ...
        model.addAttribute("currentMemberId", currentMemberId); // 댓글용
